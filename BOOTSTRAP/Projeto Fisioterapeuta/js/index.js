...
$(document).ready(function(){
    ...
    // MOSTRANDO FOTO DO MATHEUS COM ESQUELETO
    // $(window).scroll(function() {
    //     if ($(this).scrollTop() < 200){
    //         $("#img-matheus-esqueleto").hide(1000);
    //      }
    //     else{
    //       $("#img-matheus-esqueleto").show(2000);
    //      }
    // });

    // EFEITO QUANDO PASSA MOUSE NAS IMAGENS INDEX SERVIÇOS
    // $(".p-servicos").hide();

    // $("#img-osteo").mouseover(function(){
    //     $("#p-osteo").slideToggle(1000);
    // });
    // $("#img-fisio").mouseover(function(){
    //     $("#p-fisio").slideToggle(1000);
    // });
    // $("#img-quiro").mouseover(function(){
    //     $("#p-quiro").slideToggle(1000);
    // });
    // $("#img-masso").mouseover(function(){
    //     $("#p-masso").slideToggle(1000);
    // });
    // $("#img-acun").mouseover(function(){
    //     $("#p-acun").slideToggle(1000);
    // });
    // $("#img-eletro").mouseover(function(){
    //     $("#p-eletro").slideToggle(1000);
    // });
});
...
$(document).ready(function(){
    ...
    // MOSTRANDO AS NOTICIAS QUANDO ROLA
    // $(window).scroll(function() {
    //     if ($(this).scrollTop() < 2000){
    //         $("#noticias").slideUp(2000);
    //      }
    //     else{
    //       $("#noticias").slideDown(2000);
    //     }
    // });
});
